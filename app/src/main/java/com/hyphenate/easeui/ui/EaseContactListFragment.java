 ...
 * contact list
 */
public abstract class EaseContactListFragment extends EaseBaseFragment implements View.OnClickListener {
    private static final String TAG = "EaseContactListFragment";
    protected List<EaseUser> contactList;
    protected List<EaseUser> contactBlackList;
    ...
    // 查询好友头像昵称
    SimplifyThread friendDetailsThread;
    HashMap<String, String> friendPhoneMap;
    ...
    Handler mhandler = new Handler(new Handler.Callback() {
        ...
        public boolean handleMessage(Message message) {
            switch (message.what) {
                case 0:
                    Log.i("The FriendDetails-->", message.obj.toString());
                    break;
                case 1:
    ...
    protected void initView() {
        contentContainer = getView().findViewById(R.id.content_container);
    ...
    protected void setUpView() {
        ...
        contactBlackList = new ArrayList<EaseUser>();
        getContactList();
//        //init list
//        contactListLayout.init(contactList, contactBlackList, R.layout.adapter_selectmenber);
...
//
    ...
    private void getFriendDetails(List<EaseUser> contactList) {
        friendPhoneMap = new HashMap<>();
        String friendPhoneStr = "";
        for (int i = 0; i < contactList.size(); i++) {
            if (i == 0) {
                friendPhoneStr = contactList.get(i).getUsername();
            } else {
                friendPhoneStr = friendPhoneStr + "," + contactList.get(i).getUsername();
            }
        }
        friendPhoneMap.put("list", friendPhoneStr);
        friendDetailsThread = new SimplifyThread(UrlUtil.USER_NICKNAME, friendPhoneMap);
        final Message msg = new Message();
        friendDetailsThread.setOnKeyResultListener(new SimplifyThread.OnResultListener() {
            @Override
    ...
    public abstract void onViewClink(View v);
