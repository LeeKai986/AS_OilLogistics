...
public class AutoFitTextView extends TextView {
    ...
    /**
     * getTextSize 返回值是以像素(px)为单位的，而 setTextSize() 默认是 sp 为单位 * 因此我们要传入像素单位 setTextSize(TypedValue.COMPLEX_UNIT_PX, size);
     */
    ...
    /**
     * @param textSize * @param text * @return 字符串所占像素宽度
     */
