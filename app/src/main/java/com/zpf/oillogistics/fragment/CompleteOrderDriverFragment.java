...
public class CompleteOrderDriverFragment extends Fragment implements DriverOrderAdapter.DriverOrderListener {
                            ...
                            if (order.getStatus() == 0) {
                                ...
                                if(mList.size()!=0) {
                                    ...
                                    if (adapter == null) {
                                        ...
                                        adapter.setDriverOrderListener(CompleteOrderDriverFragment.this);
