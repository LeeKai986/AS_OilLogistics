...
import com.hyphenate.easeui.ui.CustomSwipeListView;
import com.hyphenate.easeui.ui.SwipeItemView;
...
public class NewFriendsMsgAdapter extends ArrayAdapter<InviteMessage> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (slideView == null) {
            ...
            View itemView = View.inflate(context, R.layout.em_row_invite_msg, null);
            holder.avator = (ImageView) itemView.findViewById(R.id.avatar);
            holder.name = (TextView) itemView.findViewById(R.id.name);
            holder.message = (TextView) itemView.findViewById(R.id.message);
            holder.agreeBtn = (TextView) itemView.findViewById(R.id.agree);
            holder.refuseBtn = (TextView) itemView.findViewById(R.id.refuse);
    ...
    private void refuseInvitation(final TextView buttonAgree, final TextView buttonRefuse, final InviteMessage msg) {
        final ProgressDialog pd = new ProgressDialog(context);
        String str1 = context.getResources().getString(R.string.Agree_with_failure);
