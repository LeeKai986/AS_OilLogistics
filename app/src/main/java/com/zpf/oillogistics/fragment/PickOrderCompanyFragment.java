...
public class PickOrderCompanyFragment extends Fragment implements CompanyOrderAdapter.CompanyOrderListener {
                        ...
                        try {
                            ...
                            if (order.getStatus() == 0) {
                                ...
                                if (adapter == null) {
                                    ...
                                    adapter.setCompanyOrderListener(PickOrderCompanyFragment.this);
