...
public class EaseContactList extends RelativeLayout {
    ...
    protected EaseContactAdapter adapterB;
    protected List<EaseUser> contactList;
    protected List<EaseUser> contactBList;
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_UPDATE_LIST:
                ...
                if(adapterB != null){
                    adapterB.clear();
                    adapterB.addAll(new ArrayList<EaseUser>(contactBList));
     ...
     * init view
     */
    public void init(FriendDetailsBean friendDetailsBean, List<EaseUser> contactList, List<EaseUser> contactBList, int layoutID){
    	this.contactList = contactList;
        this.contactBList=contactBList;
        adapter = new EaseContactAdapter(context, layoutID, new ArrayList<EaseUser>(contactList), friendDetailsBean);
        ...
        if(contactBList!=null) {
            adapterB = new EaseContactAdapter(context, 0, new ArrayList<EaseUser>(contactBList), friendDetailsBean);
            adapterB.setPrimaryColor(primaryColor).setPrimarySize(primarySize).setInitialLetterBg(initialLetterBg)
                    .setInitialLetterColor(initialLetterColor);
        }
        if(showSiderBar){
