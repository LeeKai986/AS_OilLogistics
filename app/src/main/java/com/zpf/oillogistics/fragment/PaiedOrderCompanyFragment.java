...
public class PaiedOrderCompanyFragment extends Fragment implements CompanyOrderAdapter.CompanyOrderListener {

    @BindView(R.id.lin_wu_paied_company_order)
    LinearLayout linWu;
    @BindView(R.id.lv_paied_company_order)
    PullToRefreshListView lvPaied;
    Unbinder unbinder;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_self_paied_company_order, container, false);
    ...
    private void init() {
        ...
        lvPaied.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
        ...
        lvPaied.setScrollingWhileRefreshingEnabled(true);
        lvPaied.setMode(PullToRefreshBase.Mode.BOTH);
                        ...
                        try {
                            ...
                            if (order.getStatus() == 0) {
                                ...
                                if (adapter == null) {
                                    ...
                                    adapter.setCompanyOrderListener(PaiedOrderCompanyFragment.this);
                                    lvPaied.setAdapter(adapter);
                                } else {
