...
public class PickedOrderCompanyFragment extends Fragment implements CompanyOrderAdapter.CompanyOrderListener {
    @BindView(R.id.lin_wu_picked_company_order)
    LinearLayout linWu;
    @BindView(R.id.lv_picked_company_order)
    PullToRefreshListView lvPicked;
    Unbinder unbinder;
    private View view;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.frag_self_picked_company_order, container, false);
    ...
    private void init() {
        ...
        lvPicked.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
            @Override
        ...
        lvPicked.setScrollingWhileRefreshingEnabled(true);
        lvPicked.setMode(PullToRefreshBase.Mode.BOTH);
                        ...
                        try {
                            ...
                            if (order.getStatus() == 0) {
                                ...
                                if (adapter == null) {
                                    ...
                                    adapter.setCompanyOrderListener(PickedOrderCompanyFragment.this);
                                    lvPicked.setAdapter(adapter);
                                } else {
