 ...
 * <br/>
 * <br/>
 * you can see FriendsChatActivity in demo for your reference
 */
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected int[] itemStrings = {R.string.emp, R.string.attach_picture, R.string.attach_take_pic, R.string.emp};
    //     R.string.attach_location
    protected int[] itemdrawables = {0, R.drawable.ease_chat_image_selector, R.drawable.ease_chat_takepic_selector,
            0};
    //    R.drawable.ease_chat_location_selector
    protected int[] itemIds = {0, ITEM_PICTURE, ITEM_TAKE_PICTURE, 0};
    //    , ITEM_LOCATION
...
//            titleBar.setRightImageResource(R.mipmap.head_friends_social);
        } else {
        ...
        public void onClick(int itemId, View view) {
            ...
            switch (itemId) {
                ...
                case ITEM_LOCATION:
                    ...
                    inputMenu.chatPrimaryMenu.toggleFaceImage();
                    break;
                default:
                    break;
            }
