...
import static com.zpf.oillogistics.R.id.query;
...
//			public void run() {
//				EMConversation conversation = EMClient.getInstance().chatManager().getConversation("", EMConversation.EMConversationType.GroupChat).getLastMessage();
//				conversation.
//				List<EMMessage> resultList = conversation.searchMsgFromDB(query.getText().toString(), System.currentTimeMillis(), 50, null, EMConversation.EMSearchDirection.UP);
//			}
//		}).start();
	}
}
